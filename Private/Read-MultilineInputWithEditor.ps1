function Read-MultilineInputWithEditor {
<#
.SYNOPSIS
Opens a text editor for user input and reads multiline text.

.DESCRIPTION
This function creates a temporary file, opens it in Notepad (or another specified editor) for user input,
waits until the editor is closed, reads the content from the file, and returns it as a string.
It automatically deletes the temporary file after reading.

.PARAMETER TempFilePath
The path of the temporary file used to store the user input.

.EXAMPLE
$Content = Read-MultilineInputWithEditor -TempFilePath "$env:TEMP\\mytemp.txt"

This will open Notepad, allow the user to input multiline text, and capture the text in the variable $Content.
...
#>
    ...
    # Determine editor (default to Notepad)
    $Editor = 'notepad.exe'

    # Open the editor and wait until it closes
    Write-Host 'Please enter your text in the editor. Save and close it when finished...' -ForegroundColor Cyan
    Start-Process -FilePath $Editor -ArgumentList $TempFilePath -Wait
    ...
    if (Test-Path -Path $TempFilePath) {
        ...
        Write-Error -Message 'Temporary file was not found.'
        return $null
    }
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUrCARebuFDyasZhyJpojpou7c
# CUeggiT/MIIFjTCCBHWgAwIBAgIQDpsYjvnQLefv21DiCEAYWjANBgkqhkiG9w0B
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSx56+x
# jBsLXSDUbuFHK4FYZIfOnDANBgkqhkiG9w0BAQEFAASCAQBr1Tuv5jBajFRgyRxL
# pjX463EKIxzrAQwM5MBglEpPTCuD5L+LFNdSWvJr/nAcxALl7X8cSWlRwFzyI0q1
# k5ivHY1dpVcFnk3ajyM3gg1MvgQRen2fqAPU9A9Fp2P8E4YZtaf5MQC0wPIiRSCu
# Gp421J2OrWaeZpaWiWX0H5R4ahf25+D4VNDQEO3Yk8/km7z+UcPW22+SPeXtzd6D
# H2nlqg/rXSOq42ZOZiy4g3Lfqak3IzwSZNpFgUCWIuHDWCZD49u1pRx8HTLAEW5/
# mlBywkLtM5nKxUGObsSTR1s8lWW0og1992pNDj/gvuwhOChXMiMISgLfFrGoYRJd
# LILSoYIDIDCCAxwGCSqGSIb3DQEJBjGCAw0wggMJAgEBMHcwYzELMAkGA1UEBhMC
...
# 9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1MDQyODIwMTA0MlowLwYJKoZIhvcNAQkE
# MSIEIMdC7AfulW9CMpkN8BvfAxEGZyMB/2zmn2vjcbCQ7CNhMA0GCSqGSIb3DQEB
# AQUABIICADx9lMxoO5WNGmzUMR3mlk6eToqWyoe+iha3YchomAIpRetW9iECMdZP
# 4p+DU7C+4OzMfDd1V8hizx6V/elix9ZmlTvOHJLxiGYpnAcxQ9JtgybH6ciV3ZC9
# gnMSlL4aUBlvPOZ9uk99bZCIQ6e4c8wPM2OZkFiwmmBBE5PqQqW0OLVszDRTbdzE
# zwbn5Kko88xfP4XAnuttX1wViFr9vD9WINA59OtJWl9PufKb/f+nP9BUSpQ/YE53
# 4XMiIGzPs7/+4h2yBmANFwbs2zJWfQz+56nanAZZS/xDU5g2jLoJ3we0pC8SoJDn
# 4k3m1EI/6prZhY7R8Zw4DyIHPLWoyfaf5VT/ipcnKh/g6sY2JpEAJjmS3zZrPy2q
# 72e8URMH01xnIQseZfUK3CQ6MObF5vqHuqtRt5gfaFqTyMrG++XGxeQUfK1GfXiX
# /H1qYts/tY9KU6NoYCha8691CVJgYyWCRJQXuNouM49kXewy8U9D4x3EmNe/WftE
# 6gODKAMuT+kfTSpt1OQyZxD4mglX1EXUS2pzlq3GPQkRL2JIsZktKu60H/GNXxLR
# fwiNP5noCjfVYcIGVQhDfejpt5bsOUP+qbTMKymuPHr3+XNFjGcMAnCezB1FMXD5
# P6y8cf++Z1768gOt9IVKXjFrZJ5Vej2cdMQErjojfYzz030MeCU3
