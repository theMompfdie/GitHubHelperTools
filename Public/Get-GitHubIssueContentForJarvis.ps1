function Get-GitHubIssueContentForJarvis {
    param (
        [Parameter(Mandatory)]
        [string]$Owner,
        [Parameter(Mandatory)]
    ...
    $IssueNumber = Read-Host 'Bitte gib die Issue-Nummer ein'

    # Issue abrufen
    $IssueUri = "https://api.github.com/repos/$Owner/$Repo/issues/$IssueNumber"
    $Issue = Invoke-RestMethod -Uri $IssueUri -Headers $Headers -Method Get

    # Ausgabe aufbereiten
    $Assignee = if ($Issue.assignee) { $Issue.assignee.login } else { 'Kein Assignee gesetzt' }
    $Milestone = if ($Issue.milestone) { $Issue.milestone.title } else { 'Kein Milestone gesetzt' }
    $Labels = if ($Issue.labels) { ($Issue.labels | ForEach-Object { $_.name }) -join ', ' } else { 'Keine Labels gesetzt' }

    $Output = @"
# Issue #$($Issue.number): $($Issue.title)

**Status:** $($Issue.state)
**Erstellt am:** $($Issue.created_at)
**Letztes Update:** $($Issue.updated_at)

**Assignee:** $Assignee
**Milestone:** $Milestone
**Labels:** $Labels

**Link:** [$($Issue.html_url)]($($Issue.html_url))
...
"@
    ...
    Write-Host "✅ Zusammenfassung wurde erstellt und in die Zwischenablage kopiert!" -ForegroundColor Green
    Write-Host "`nHier ist die Vorschau:`n"
    $Output
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUwgoOXPC7/Ib9J24UvofbNQaG
# IoCggiT/MIIFjTCCBHWgAwIBAgIQDpsYjvnQLefv21DiCEAYWjANBgkqhkiG9w0B
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBS7ZqRw
# 8S+fSntCD3c+inJ/Nov0sDANBgkqhkiG9w0BAQEFAASCAQBb2i1AHg/6rZSO5ZbB
# vVeo6t3/K1J1Mznz2YRuaZFxLBmuZHq0/zNfU6XLIDwJb2NPUqP7E89HvmnMR5Mg
# aCGQsUJe/PNd/ltbxy3HBd2RbmrwTXsHGQHszEtRo1hjMwIjLrUpXVGO5T4/uyBB
# L7CdrAdXVK14U6h1G5vx22d2klu2moHLeiONHwTc+cRYA8Hr/4hfqSFKWkwTTLpv
# QHRiQroXUXNJl8W2KGdpePC7V+g+uSUSABARBYegjIy9URkgvYTqhPk2eSqRVLFV
# TCjDT31ExpyElPNaPB4jIXdHyf0OZmfInbw1jCUbJZdaOBU9lkATi1VO+AnVWeI5
# 9vLKoYIDIDCCAxwGCSqGSIb3DQEJBjGCAw0wggMJAgEBMHcwYzELMAkGA1UEBhMC
...
# 9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1MDQyODIwMjMxNVowLwYJKoZIhvcNAQkE
# MSIEIKSoC6B7QG7ZJXswBcYiSIwcdwTCC/03pa/cDPIZ4L4TMA0GCSqGSIb3DQEB
# AQUABIICACe2+lOTvOGxTGHO/bcK1JXoSVLRhhtXmShoszwPjohlj3TQpXOFZCbn
# sHYhz3oGWYXP76uNX1z0vbXzvJ201Bh4mLtx6CPKYuwet3oURtsKcnwobZqwXaKI
# Q6MAXUXSb21i6OPJ4bQuiPbJGZVGv1erwQZp2bPCnLidI6MCx+JxCeJYS0fJWra5
# VXWNOQ2VF+3Air62gJVTHeczc01udfjL0tfY2WnwdqcRIOGNLQJ0zDv5vP/aeqzt
# InAq+n5KFqGuwrD2ruOjYkRh9h3L4FJgWyxtzQyskafldVYa1X9c4CR0n5uCgI6m
# idjIt1Qxk9VuIokD/rQxJ1QFxn4FpQdo2KFTUt95WALseAVhutwohJ5n1qhTGvtH
# b2jON9HgYX6VVkckjyRo75GaeT1rk50nLdgulDi+yJoeIbcfkouN8p2TK5aqLN6r
# DpZB3v7IoRQkWNQpJMwjT3atuvUYA+2kF3Ua/2z2lw66o2lGugjAN7Ozf5ZSx3LM
# gpwjjoG/5//ml1dBJbxjcJHNvj4mbtw8zqyz3E97sUWy/P3w5tJtNI4Gh2IxmnUC
# 77Orhf6qDUfKHcKUiPXtbm++Gm6fIHsC3tSGee2ICqoydLmYrXzSax8l/8raLD7A
# wzoWx/WeAply6qvVqubH7J2vh//n8a253xS9v4LixJYmISJiGc7/
