function New-MilestoneOnGitHub {
<#
.SYNOPSIS
Creates a new milestone in a GitHub repository.

.DESCRIPTION
This function allows you to create a new milestone in a specified GitHub repository.
You can specify the title and description, and optionally a due date.
The description is collected using a multiline editor for better formatting.
...
.EXAMPLE
New-MilestoneOnGitHub -Owner 'theMompfdie' -Repo 'IceSelfCheckIn' -GitHubToken 'your_token_here'
...
#>
    ...
    $MilestoneTitle = Read-Host 'Enter the milestone title'

    # Open editor for description
    $TempFile = [System.IO.Path]::GetTempFileName()
    $MilestoneDescription = Read-MultilineInputWithEditor -TempFilePath $TempFile

    # Ask for optional due date
    $DueDate = Read-Host 'Enter a due date (YYYY-MM-DD) or leave empty'
    ...
    if ($DueDate) {
        $Body['due_on'] = ([datetime]::ParseExact($DueDate, 'yyyy-MM-dd', $null)).ToString('yyyy-MM-ddTHH:mm:ssZ')
    }

    $MilestonesUri = "https://api.github.com/repos/$Owner/$Repo/milestones"
    $BodyJson = $Body | ConvertTo-Json -Depth 3

    Invoke-RestMethod -Uri $MilestonesUri -Headers $Headers -Method Post -Body $BodyJson

    Write-Host "✅ Milestone '$MilestoneTitle' created successfully." -ForegroundColor Green
}

# SIG # Begin signature block
# MIIrcwYJKoZIhvcNAQcCoIIrZDCCK2ACAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUjJHx0FNVFmiFOnJ5MDyVEJM6
# B2SggiT/MIIFjTCCBHWgAwIBAgIQDpsYjvnQLefv21DiCEAYWjANBgkqhkiG9w0B
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTxiCgh
# PjeikCV9t7GhYAHJ3rkh3DANBgkqhkiG9w0BAQEFAASCAQAs0lEDR0pWrdfG1FsC
# d8OENi7J7IUDEJj+eodiWKmmrxXuZX5WTmVdQITqXeiWWJinjCLOSM/TMWivkop8
# QbFDAVJTiINKCyhMKaJphySLm45UQBMGip6XVSR9LFxs8PS4Rfc2XG0/4LKxbo/j
# 6S1j5nLxZ8gjjHA+mRldDPNVNlvO3IzJIO9w1t+I5IwZJ3wBZr9HEfs4sKo1froP
# wwH4I5UNcGAzMeJabZF4OMFZt5aZlzBCKcrHaGY9Pd/e35pC+hqHs8M9q0hZwjCW
# fWzEegVRHHTRnaaAXwRVs1iIiW7VpBsNwlk7CFKqnxtjspbOW4PYV8pdt/fty5Yl
# ORnloYIDIDCCAxwGCSqGSIb3DQEJBjGCAw0wggMJAgEBMHcwYzELMAkGA1UEBhMC
...
# 9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1MDQyODIwMTUwNVowLwYJKoZIhvcNAQkE
# MSIEIEHKYazFyEnQ+Fh/JDIkVzZ2reAg5dC0DMHD0V47Xw/5MA0GCSqGSIb3DQEB
# AQUABIICAJ/2bSEBnZnqPjoMvP0sxuaSab/k9L5yLhICTqjhBG6pwPTtALk28eRj
# 78da1Dp2K/RXPj/OE6/Zro0YDRX/qoRutOzMGsX8ziiYzjLS5J4dkBcKE0DSOQRm
# uFvoQKHud6ytFzRjwDxIPIWJS4a8pvzqTsBT0lrIQGXUgSY9h4rYoY+8zQqvQlkn
# 2cjNYT1wtB6LD0tEKNkC5ZM1a/W/ENXJvVVEGbnoXl+LpLienCnWTMRCI15G675B
# PtqKKqpVfNViab+2yEPRQ+b7A0IVmsukqrBYiTcfnXpxOJC7nmSOlmOklNT10YA3
# rReNvgJf8QGsgThrjJ2KfyFAt6VqyznmlcPjWJwhh0dfH6SgJ6YRJDyVi9PDrtmo
# v3IOwgK7sj64m4ErnB33EFT9CWCm+MnN6vxJUA3wz97x+577/O9igHVufrekPidJ
# AJKYCBOd8u//HZzl8D5LIa4Vua3vJZDizEbWJsxWHU+J/aBhQLO4i1IfjX/CHoIJ
# 31FIwRZHMXcCTF2NHKfHYapnvTH7wT8IVigKOH99kbMHT+lel86s5SloT4RMNxDG
# s4rtMClj1XEmaeufkMEEYkpoJZxHQoXXd0DD8emfCKvcR2JCRqEtIbWAaztXhl3A
# /JAU0uGzzMFp4cTQZBuREu+bX+DgQBpi6KFXXyvUMYyqBcsVdVgh
