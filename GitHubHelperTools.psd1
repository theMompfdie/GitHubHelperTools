@{
    RootModule        = 'GitHubHelperTools.psm1'
    ModuleVersion     = '1.0.0'
    Author            = 'Raimund Plissnig'
    Description       = 'A PowerShell module for managing GitHub Issues, Labels, and Milestones.'
    PowerShellVersion = '7.0'
    FunctionsToExport = @(
        'New-IssueOnGitHub',
        'Update-IssueOnGitHub',
        'New-LabelOnGitHub',
        'New-MilestoneOnGitHub',
        'Get-GitHubIssueContentForJarvis',
        'Get-GitHubMilestoneAndConnectedIssueToClip'
    )
    PrivateData = @{
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUgXtaYAvSjOxYjJCZ7aVFWzWU
# TuiggiT/MIIFjTCCBHWgAwIBAgIQDpsYjvnQLefv21DiCEAYWjANBgkqhkiG9w0B
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBT2O37w
# tfGlSAMYAtxGOUx3XB41gDANBgkqhkiG9w0BAQEFAASCAQAo4i9k5VO6gbfkm/Px
# ciXeDMvyIqob4BN/E7+QWQ7nxMipCU/2G2dz7Re6J2g8wZA0vzlgPNCtTRrnaUxm
# Gf1djkajw9XBGOd+IOvLSrozLfki/yfe5Xa8MPxSRdPt7WlsrgS3pCtHYikPhU93
# ++tuEOqk1uLxiKcR37IFi1j6XyyXDlSFix2LLUBBdY7YdqPdjnN0Qi8mFIF1y/CP
# ZCDZ3dypdbBaZaygv/0kdyiNJ84UFmueYOBg3nrwo+oZhvRCv6fERH0vlGTT4fk1
# MspWPf6jCcfj58K9pcMDmTRuiIEqiE5Q2TKF23RpgTh/DarPHsRnJBDNkanhCRxH
# 6HZwoYIDIDCCAxwGCSqGSIb3DQEJBjGCAw0wggMJAgEBMHcwYzELMAkGA1UEBhMC
...
# 9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1MDQyODIwMjUwNlowLwYJKoZIhvcNAQkE
# MSIEIBiX5cBZhsWQC3H68X+KEHINE3hzxC5zzHbZrUOR3L8IMA0GCSqGSIb3DQEB
# AQUABIICAKUjZx52jLLXB4AQ72NkhR4EHkrYu1r0ILNDMZUnhLpLiz+GianqjPYa
# uDmTVPxsYIVYScSnTy/oHFn6rScTeMRVDAb1bIW6c0y8JWBEw2xnupYmgg5GmMSx
# LfjLvXpdROU+CTFwvZ3nUYoB0Jo+t+4TBq+nc9d3wNBaJg23ZS1/YqOcKW9MTShL
# TnGb0ZiEMgDMn+ceAC4rpw9swSv/RI9XEnCIi82vvsEEkwg512Fkd8/wB9FbO9UW
# pbBFe4lW3+im1B0kce2Je20kwwhXLelRxAa+0d9wTie3wcQ98kiNIvux4yOFZ1rl
# 2JfrRZBhRMDsMMMSZB5nYXyXjoZjMO/NZSg9UlBa6x5Omy4f3qlvy4vu93Az+Z6g
# owL7bnLiR7DMo7RE0Zm/c/s4oUd4odrajDI9rsXSto2yUT7AFCEry5WpWzTxBb/E
# NnLhERGkVow6XKhd32wU4m/Uv360wCIHYhZruWmno+juTGpr+2rkGo6Kfy95rWSX
# upoVpo2oeFGG6z54uyhTV3keMcGgjZ3XaDM+ZVU2I7mAVGEBIq4aF5qSfe7chY6b
# uQlwUeJmbC3tchF3M7PVARWXjIhQOa8K5kf867g9hP6nXf8tn0j3lFz0pyYABTqN
# HQn+hNxLFZhasL/EpMpGSbhSNBWlLHAV+Pon/Sr3qjOV2XVvCIJM
